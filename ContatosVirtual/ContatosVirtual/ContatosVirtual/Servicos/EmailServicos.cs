...
{
    public class EmailServicos : IEmail
    {
        public string EnviaMensagemEmail(string destinatario, string mensagem, string assunto, string enviadoDe)
        {
            try
            {
        ...
        public string GerarMensagemEmailNovoUsuario(string nomeUsuario, string senha)
        {
        ...
        public string GerarMensagemRecuperarSenha(string idUsuario)
        {
